...
public class Checkout_Chrome_Page {

public WebDriver driver;
	
	//locators - elements
	@FindBy(xpath="//div/p/span[@id=\"our_price_display\"][text()='$16.40']")
	...
	@FindBy(xpath="//div[@class='layer_cart_row'][1]/span[text()='$16.40']")
	public WebElement cart_price;
	
	@FindBy(xpath="//div/span[@id='layer_cart_product_quantity'][text()='1']")
	public WebElement cart_quantity;
	
	@FindBy(xpath="//div/span[@id='layer_cart_product_price'][contains(text(),'$16.40')]")
	...
	public Checkout_Chrome_Page(WebDriver driver)
	{
		this.driver=driver;
